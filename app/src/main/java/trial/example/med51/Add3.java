...
public class Add3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(Add3.this);
        ...
        saveInfoBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pd.show();
                getData();
                startActivity(new Intent(Add3.this, Porbandar.class));
                Toast.makeText(Add3.this, "Information Added Successfully!", Toast.LENGTH_SHORT).show();
            }
        });
