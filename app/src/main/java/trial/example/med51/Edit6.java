...
public class Edit6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(Edit6.this);
        ...
        saveInfoBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getData();
                startActivity(new Intent(Edit6.this, Bilimora.class));
                Toast.makeText(Edit6.this, "Updated Successfully!", Toast.LENGTH_SHORT).show();
            }
        });
    }
