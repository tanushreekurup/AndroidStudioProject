...
public class Adapter7 extends RecyclerView.Adapter<Adapter7.Holder> {

    private Context context;
    private ArrayList<Model> arrayList;
    Helper7 databaseHelper;

    public Adapter7(Context context, ArrayList<Model> arrayList) {
        this.context = context;
        this.arrayList = arrayList;
        databaseHelper = new Helper7(context);
    }
    ...
    private void editDialog(String position, final String id, final String name, final String address, final String phone, final String image, final String addTimeStamp, final String updateTimeStamp) {
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(context, Edit7.class);
