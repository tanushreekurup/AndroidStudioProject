...
public class Add6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(Add6.this);
        ...
        saveInfoBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pd.show();
                getData();
                startActivity(new Intent(Add6.this, Bilimora.class));
                Toast.makeText(Add6.this, "Information Added Successfully!", Toast.LENGTH_SHORT).show();
            }
        });
