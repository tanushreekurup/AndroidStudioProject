...
public class Add2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(Add2.this);
        ...
        saveInfoBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pd.show();
                getData();
                startActivity(new Intent(Add2.this, Kutch.class));
                Toast.makeText(Add2.this, "Information Added Successfully!", Toast.LENGTH_SHORT).show();
            }
        });
