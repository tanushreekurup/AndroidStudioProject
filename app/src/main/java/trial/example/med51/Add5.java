...
public class Add5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(Add5.this);
        ...
        saveInfoBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pd.show();
                getData();
                startActivity(new Intent(Add5.this, Bhavnagar.class));
                Toast.makeText(Add5.this, "Information Added Successfully!", Toast.LENGTH_SHORT).show();
            }
        });
