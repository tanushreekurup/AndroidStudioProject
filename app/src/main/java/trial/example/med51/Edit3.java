...
public class Edit3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(Edit3.this);
        ...
        saveInfoBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getData();
                startActivity(new Intent(Edit3.this, Porbandar.class));
                Toast.makeText(Edit3.this, "Updated Successfully!", Toast.LENGTH_SHORT).show();
            }
        });
    }
