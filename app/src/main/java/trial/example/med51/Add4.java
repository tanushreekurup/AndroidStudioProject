...
public class Add4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(Add4.this);
        ...
        saveInfoBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pd.show();
                getData();
                startActivity(new Intent(Add4.this, Rajkot.class));
                Toast.makeText(Add4.this, "Information Added Successfully!", Toast.LENGTH_SHORT).show();
            }
        });
