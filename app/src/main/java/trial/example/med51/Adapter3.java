...
public class Adapter3 extends RecyclerView.Adapter<Adapter3.Holder> {

    private Context context;
    private ArrayList<Model> arrayList;
    Helper3 databaseHelper;

    public Adapter3(Context context, ArrayList<Model> arrayList) {
        this.context = context;
        this.arrayList = arrayList;
        databaseHelper = new Helper3(context);
    }
