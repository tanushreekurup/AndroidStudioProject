...
public class Edit5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(Edit5.this);
        ...
        saveInfoBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getData();
                startActivity(new Intent(Edit5.this, Bhavnagar.class));
                Toast.makeText(Edit5.this, "Updated Successfully!", Toast.LENGTH_SHORT).show();
            }
        });
    }
