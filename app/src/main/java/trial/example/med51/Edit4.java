...
public class Edit4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(Edit4.this);
        ...
        saveInfoBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getData();
                startActivity(new Intent(Edit4.this, Rajkot.class));
                Toast.makeText(Edit4.this, "Updated Successfully!", Toast.LENGTH_SHORT).show();
            }
        });
    }
