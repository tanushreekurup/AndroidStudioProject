...
public class Edit7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit7);

        actionBar = getSupportActionBar();
        actionBar.setDisplayHomeAsUpEnabled(true);
        actionBar.setDisplayShowHomeEnabled(true);

        pd = new ProgressDialog(Edit7.this);
        ...
        saveInfoBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getData();
                startActivity(new Intent(Edit7.this, Surat.class));
                Toast.makeText(Edit7.this, "Updated Successfully!", Toast.LENGTH_SHORT).show();
            }
        });
    }
